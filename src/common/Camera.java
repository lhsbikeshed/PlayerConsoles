 ...
 *
 * MODIFIED TO FUCK BY TOM@IMAKETHIN.GS
 * 
 * added rotation about axis (rotateX Y Z)
 * added ability to move camera and target
 * added ability to set camera params for a pgraphics context
 *
...
public class Camera
{
   ...
   public void feedTo(PGraphics pg){
   ...
   public void setPosition(float positionX, float positionY, float positionZ){
	   float offX = theTargetX - theCameraX;
	   float offY = theTargetY - theCameraY;
	   float offZ = theTargetZ - theCameraZ;
	   
	   theCameraX = positionX;
	   theCameraY = positionY;
	   theCameraZ = positionZ;
	   
	   theTargetX = theCameraX + offX;
	   theTargetY = theCameraY + offY;
	   theTargetZ = theCameraZ + offZ;
   ...
   public void rotateXBy(float anElevationOffset)
   {
   ...
   public void rotateYBy(float anAzimuthOffset)
   {
   ...
   public void rotateZBy(float aRollOffset)
   {
   ...
   public void rotateX(float newAngle){
	   theElevation = newAngle; //constrain(newAngle,TOL-HALF_PI, HALF_PI-TOL);
	   updateTarget();
   }
   
   /** Rotate the camera about its Y axis */
   public void rotateY(float newAngle)
   {
      // Calculate the new azimuth for the camera
      theAzimuth = (newAngle + TWO_PI) % TWO_PI;
   ...
   /** Rotate the camera about its Z axis */
   public void rotateZ(float newAngle)
   {
       // Change the roll amount
       theRoll = (newAngle + TWO_PI) % TWO_PI;
