...
public class HardwareController {
	...
	public HardwareController(String interfaceName, String port, int rate, PlayerConsole parent){
	...
	/* take contents of buffer and convert to hardwareevent 
	 * This needs to be overriden for each stations hardware as each thing
	 * produces its own mess of data
	 * */
