...
public interface VectorConstants {
	...
	public static final PVector NaN = new PVector(Float.NaN, Float.NaN,
			Float.NaN);

	/** A vector with all coordinates set to positive infinity. */
	public static final PVector POSITIVE_INFINITY = new PVector(
			Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY,
			Float.POSITIVE_INFINITY);

	/** A vector with all coordinates set to negative infinity. */
	public static final PVector NEGATIVE_INFINITY = new PVector(
