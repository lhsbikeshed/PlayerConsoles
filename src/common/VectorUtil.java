...
/**
 * This class is used internally by the library and provides some additional
 * methods not covered in the PVector class. <br>
 * 
 * @author Peter Lager
 * 
 */
public class VectorUtil {
	...
	/**
	 * Return a copy of the original vector. Effectively performs the action of
	 * the copy constructor missing from PVector.
	 * 
	 * @param v
	 ...
	 * part of the Apache commons math library at
	 * http://commons.apache.org/math/ <br>
	 * 
	 * @param v
	...
	public static PVector orthogonal(PVector v) {
		...
		if (threshold == 0) {
			System.out.println(Messages.build("Vector {0} has zero magnitude",
					v));
			return null;
		}
	...
	/**
	 * Compares a PVector with a set of 3D coordinates. They are considered the
	 * same if the difference is less than 1e-5f for each value (x,y & z)
	 * 
	 * @param v0
	 * @param x
	 * @param y
	...
	/**
	 * Compares 2 PVectors. They are considered the same if the difference is
	 * less than 1e-5f for each attribute (x,y & z)
	 * 
	 * @param v0
	 * @param v1
