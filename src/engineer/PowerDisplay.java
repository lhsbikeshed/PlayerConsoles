...
public class PowerDisplay extends Display {
  ...
  int[] powerColours = {UsefulShit.makeColor(255,0,0), UsefulShit.makeColor(255,255,0), UsefulShit.makeColor(0,255,0)};
  ...
  public PowerDisplay(PlayerConsole parent) {
    ...
    hullStateImage = parent.loadImage("engineerconsole/hulldamageoverlay.png");
    reactorFailOverlay = parent.loadImage("engineerconsole/reactorFailOverlay.png");
    ...
    subsystemList[0] = new FuelFlowRateSystem(parent, "Deuterium", new PVector(10, 91), parent.loadImage("engineerconsole/icons/deuterium.png"));
    switchToSystemMap.put("NEWDIAL:2", subsystemList[0]);    
    subsystemList[1] = new FuelFlowRateSystem(parent, "Tritium", new PVector(368, 91), parent.loadImage("engineerconsole/icons/tritium.png"));
    ...
    subsystemList[2] = new ModeratorCoilSystem(parent, "Moderator Rod 1", new PVector(405, 172), parent.loadImage("engineerconsole/icons/mod1.png"));
    switchToSystemMap.put("NEWDIAL:0", subsystemList[2]);
    subsystemList[3] = new ModeratorCoilSystem(parent, "Moderator Rod 2", new PVector(396, 402), parent.loadImage("engineerconsole/icons/mod2.png"));
    ...
    //field coils
    subsystemList[4] = new CoilSubSystem(parent, "Field Coil 1", new PVector(157, 205), parent.loadImage("engineerconsole/icons/coil1.png"));
    switchToSystemMap.put("NEWSWITCH:0", subsystemList[4]);
    subsystemList[5] = new CoilSubSystem(parent, "Field Coil 2", new PVector(437, 205), parent.loadImage("engineerconsole/icons/coil2.png"));
    ...
    //coolant valves
    subsystemList[6] = new OnOffSystem(parent, "Coolant Valve 1", new PVector(52, 350), parent.loadImage("engineerconsole/icons/cool1.png"));
    switchToSystemMap.put("NEWSWITCH:4", subsystemList[6]);
    subsystemList[7] = new OnOffSystem(parent, "Coolant Valve 2", new PVector(94, 350), parent.loadImage("engineerconsole/icons/cool2.png"));
    switchToSystemMap.put("NEWSWITCH:6", subsystemList[7]);
    subsystemList[8] = new OnOffSystem(parent, "Coolant Valve 3", new PVector(133, 350), parent.loadImage("engineerconsole/icons/cool3.png"));
    ...
    //coolant mixer
    subsystemList[9] = new OnOffSystem(parent, "Coolant mixer", new PVector(73, 390), parent.loadImage("engineerconsole/icons/mixer.png"));
    switchToSystemMap.put("NEWSWITCH:10", subsystemList[9]);

    //power dist
    subsystemList[10] = new MultiValueSystem(parent, "Power Dist Route", new PVector(553, 416), parent.loadImage("engineerconsole/icons/powerdist.png"), 3);
    switchToSystemMap.put("NEWSWITCH:13", subsystemList[10]);

    //turbines
    subsystemList[11] = new OnOffSystem(parent, "Turbine #1", new PVector(324, 456), parent.loadImage("engineerconsole/icons/turbine.png"));
    switchToSystemMap.put("NEWSWITCH:1", subsystemList[11]);
    subsystemList[12] = new OnOffSystem(parent, "Turbine #2", new PVector(324, 525), parent.loadImage("engineerconsole/icons/turbine.png"));
  ...
  public void draw() {
    ...
    if (lastFailureTime + nextFailureTime < parent.millis() && failureState) {
      ...
      nextFailureTime = 2000 + (long)parent.map(difficulty, 1, 10, 5000, 1000);
    ...
    for (int i = 0; i < num; i++) {
      int c = (int)parent.map( parent.sin( parent.millis() / 200.0f  - i/2.0f), -1.0f, 1.0f, 0, 255);
    ...
    parent.text((int)parent.map(reactorHealth, 0, maxReactorHealth, 0, 100), 348, 310);


    //draw hull damage
    parent.tint( (int)parent.map(hullState, 0, 100, 255, 0), (int)parent.map(hullState, 0, 100, 0, 255), 0);
    ...
    parent.fill( (int)parent.map(oxygenLevel, 0, 100, 255, 0), (int)parent.map(oxygenLevel, 0, 100, 0, 255), 0);  
  ...
  private SubSystem getRandomSystem(boolean filterWrong, boolean filterBroken) {
    ...
    int rand =(int) parent.floor(parent.random(notFailedList.size()));
