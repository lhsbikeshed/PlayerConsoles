...
public class CablePuzzleDisplay extends Display {
  ...
  */
  ...
  public CablePuzzleDisplay(PlayerConsole parent){
    ...
    bannerImg = parent.loadImage("pilotconsole/cablepuzzle/banner.png");
    
  }
  
  
  public void start(){
    ((PilotConsole)parent).getJoystick().setEnabled(false);
    
  }
  public void stop(){
	  ((PilotConsole)parent).getJoystick().setEnabled(true);
  }
